...
const (
	UserInterface_GetUserInfo_FullMethodName = "/api.bff.v1.UserInterface/GetUserInfo"
	UserInterface_Login_FullMethodName       = "/api.bff.v1.UserInterface/Login"
)
...
func (c *userInterfaceClient) Login(ctx context.Context, in *LoginReq, opts ...grpc.CallOption) (*LoginReply, error) {
	out := new(LoginReply)
	err := c.cc.Invoke(ctx, UserInterface_Login_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var UserInterface_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.bff.v1.UserInterface",
