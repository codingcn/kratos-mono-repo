...
func (x *GetUserInfoReply) GetId() uint64 {
	if x != nil {
		return x.Id
	}
	return 0
...
var file_api_user_service_v1_user_proto_rawDesc = []byte{
	...
	0x31, 0x22, 0x20, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f,
	0x52, 0x65, 0x71, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52,
	0x02, 0x69, 0x64, 0x22, 0x3e, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e,
	...
	0x61, 0x6d, 0x65, 0x32, 0x5b, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x53, 0x0a, 0x0b, 0x47,
	...
	0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x71, 0x1a, 0x21, 0x2e, 0x75, 0x73,
	...
	0x42, 0x19, 0x5a, 0x17, 0x61, 0x70, 0x69, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2f, 0x73,
...
var file_api_user_service_v1_user_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_api_user_service_v1_user_proto_goTypes = []interface{}{
	(*GetUserInfoReq)(nil),   // 0: user.configs.v1.GetUserInfoReq
	(*GetUserInfoReply)(nil), // 1: user.configs.v1.GetUserInfoReply
}
var file_api_user_service_v1_user_proto_depIdxs = []int32{
	0, // 0: user.configs.v1.User.GetUserInfo:input_type -> user.configs.v1.GetUserInfoReq
	1, // 1: user.configs.v1.User.GetUserInfo:output_type -> user.configs.v1.GetUserInfoReply
